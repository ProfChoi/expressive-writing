...
const STORAGE_KEY = "expressiveWriting4DayData";
...
export default function ExpressiveWritingApp() {
  ...
  const getResponse = (day, questionIndex) => responses[day]?.[questionIndex];
  const getScore = (day, questionIndex) => responses[day]?.[questionIndex] ?? "-";
      ...
      <div className="w-full max-w-5xl">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-stone-200">
            ...
            {hasSavedSession && (
              <div className="bg-amber-50 rounded-2xl p-5 border border-amber-200 mb-6">
                <div className="font-semibold text-amber-900 mb-2">이전 기록이 자동 복원되었습니다.</div>
        ...
        {screen === "dayIntro" && (
          <div className="bg-white rounded-3xl shadow-xl border border-stone-200 p-8 min-h-[680px] flex flex-col justify-between">
            <div>
              <BackButton />
              <div className="text-sm tracking-[0.3em] uppercase text-stone-400 mb-6">Day {current.day}</div>
        ...
        {screen === "writing" && (
          <div className="bg-white rounded-3xl shadow-xl border border-stone-200 p-8 min-h-[760px] flex flex-col">
            <div className="flex items-start justify-between gap-4 mb-6">
              <div>
                <BackButton />
                <div className="text-sm tracking-[0.3em] uppercase text-stone-400 mb-3">Day {current.day}</div>
                <h2 className="text-3xl font-bold">{current.title}</h2>
              </div>

              <div className="bg-stone-100 rounded-3xl px-6 py-4 text-center min-w-[140px]">
                <div className="text-sm text-stone-500 mb-1">{timerStarted ? "남은 시간" : "권장 시간"}</div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-stone-200 p-8 min-h-[680px] flex flex-col">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center">
              <div className="max-w-xl">
                <div className="text-sm tracking-[0.3em] uppercase text-stone-400 mb-6">Pause</div>
                <h2 className="text-5xl font-bold leading-tight mb-8">잠시 숨을 고르세요.</h2>
        ...
        {screen === "reflection" && (
          <div className="bg-white rounded-3xl shadow-xl border border-stone-200 p-8 min-h-[680px] flex flex-col justify-between">
            <div>
              <BackButton />
              <div className="text-sm tracking-[0.3em] uppercase text-stone-400 mb-6">Reflection</div>
        ...
        {screen === "final" && (
          <div className="bg-white rounded-3xl shadow-xl border border-stone-200 p-8 min-h-[680px] flex flex-col justify-between">
            <div>
              <BackButton />
              <div className="text-sm tracking-[0.3em] uppercase text-stone-400 mb-6">Final Reflection</div>
              <h2 className="text-5xl font-bold leading-tight mb-8">4일간의 글쓰기 여정을 마쳤습니다.</h2>
